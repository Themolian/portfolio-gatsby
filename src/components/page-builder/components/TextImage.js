...
const TextImage = (props) => {
    const sectionImage = props.dataSource.image.localFile.childImageSharp.gatsbyImageData;
    return (
            ...
            <div className="text-image__inner">
                ...
                <div className="text-image__content">
                    <div className="text-image__text">
                        ...
                        <GatsbyImage className="text-image__image" image={sectionImage} alt={props.dataSource.image.title} />
                </div>
            </div>
        </section>
    )
